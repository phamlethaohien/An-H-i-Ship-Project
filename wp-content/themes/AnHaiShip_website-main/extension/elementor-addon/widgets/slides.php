...
class AnHaiShipWebsite_Elementor_Addon_Slides extends Widget_Base {
    ...
    public function get_name() {
        return 'AnHaiShipWebsite-slides';
    }

    public function get_title() {
        return esc_html__( 'Slides Theme', 'AnHaiShipWebsite' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'section_content',
            [
                'label' => esc_html__( 'Slides', 'AnHaiShipWebsite' ),
            ]
        );
        ...
        $repeater->start_controls_tab( 'background', [ 'label' => esc_html__( 'Background', 'AnHaiShipWebsite' ) ] );

        $repeater->add_control(
            'slides_image',
            [
                'label'     =>  esc_html__( 'Image', 'AnHaiShipWebsite' ),
        ...
        $repeater->add_control(
            'background_size',
            [
                'label'     =>  esc_html__( 'Size', 'AnHaiShipWebsite' ),
                'type'      =>  Controls_Manager::SELECT,
                'default'   =>  'cover',
                'options'   =>  [
                    'cover'     =>  esc_html__( 'Cover', 'AnHaiShipWebsite' ),
                    'contain'   =>  esc_html__( 'Contain', 'AnHaiShipWebsite' ),
                    'auto'      =>  esc_html__( 'Auto', 'AnHaiShipWebsite' ),
                ],
                'selectors' => [
        ...
        $repeater->add_control(
            'background_overlay',
            [
                'label' => esc_html__( 'Background Overlay', 'AnHaiShipWebsite' ),
        ...
        $repeater->start_controls_tab( 'content', [ 'label' => esc_html__( 'Content', 'AnHaiShipWebsite' ) ] );

        $repeater->add_control(
            'heading',
            [
                'label' => esc_html__( 'Title & Description', 'AnHaiShipWebsite' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'Slide Heading', 'AnHaiShipWebsite' ),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => esc_html__( 'Click edit button to change this text. Lorem ipsum dolor sit amet consectetur adipiscing elit dolor', 'AnHaiShipWebsite' ),
                'show_label' => false,
            ]
        );
        ...
        $repeater->add_control(
            'button_text',
            [
                'label' => esc_html__( 'Button Text', 'AnHaiShipWebsite' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'Click Here', 'AnHaiShipWebsite' ),
            ]
        );
	    ...
	    $repeater->add_control(
		    'show_content',
		    [
			    'label'         => esc_html__( 'Show Content', 'AnHaiShipWebsite' ),
			    'type'          => Controls_Manager::SWITCHER,
			    'label_on'      => esc_html__( 'Show', 'AnHaiShipWebsite' ),
			    'label_off'     => esc_html__( 'Hide', 'AnHaiShipWebsite' ),
			    'return_value'  => 'yes',
			    'default'       => 'yes',
		    ]
	    );
        ...
        $repeater->start_controls_tab( 'style', [ 'label' => esc_html__( 'Style', 'AnHaiShipWebsite' ) ] );

        $repeater->add_control(
            'custom_style',
            [
                'label' => esc_html__( 'Custom', 'AnHaiShipWebsite' ),
                'type' => Controls_Manager::SWITCHER,
                'description' => esc_html__( 'Set custom style that will only affect this specific slide.', 'AnHaiShipWebsite' ),
            ]
        );
        ...
        $repeater->add_control(
            'horizontal_position',
            [
                'label' => esc_html__( 'Horizontal Position', 'AnHaiShipWebsite' ),
        ...
        $repeater->add_control(
            'vertical_position',
            [
                'label' => esc_html__( 'Vertical Position', 'AnHaiShipWebsite' ),
                'type' => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options' => [
                    'top' => [
                        'title' => esc_html__( 'Top', 'AnHaiShipWebsite' ),
                        'icon' => 'eicon-v-align-top',
                    ],
                    'middle' => [
                        'title' => esc_html__( 'Middle', 'AnHaiShipWebsite' ),
                        'icon' => 'eicon-v-align-middle',
                    ],
                    'bottom' => [
                        'title' => esc_html__( 'Bottom', 'AnHaiShipWebsite' ),
        ...
        $repeater->add_control(
            'text_align',
            [
                'label' => esc_html__( 'Text Align', 'AnHaiShipWebsite' ),
                'type' => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options' => [
                    'left'  =>  [
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   =>  [
                    [
                        'heading' => esc_html__( 'Slider 1 Heading', 'AnHaiShipWebsite' ),
                        'description' => esc_html__( 'Click edit button to change this text. Lorem ipsum dolor sit amet consectetur adipiscing elit dolor', 'AnHaiShipWebsite' ),
                        'button_text' => esc_html__( 'Click Here', 'AnHaiShipWebsite' ),
                        'link' => '#'
                    ],
                    [
                        'heading' => esc_html__( 'Slider 2 Heading', 'AnHaiShipWebsite' ),
                        'description' => esc_html__( 'Click edit button to change this text. Lorem ipsum dolor sit amet consectetur adipiscing elit dolor', 'AnHaiShipWebsite' ),
                        'button_text' => esc_html__( 'Click Here', 'AnHaiShipWebsite' ),
                        'link' => '#'
                    ],
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Slider Options', 'AnHaiShipWebsite' ),
        ...
        $this->add_responsive_control(
            'content_max_width',
            [
                'label' => esc_html__( 'Content Width', 'AnHaiShipWebsite' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_responsive_control(
            'slides_padding',
            [
                'label' => esc_html__( 'Padding', 'AnHaiShipWebsite' ),
        ...
        $this->add_control(
            'heading_spacing',
            [
                'label' => esc_html__( 'Spacing', 'AnHaiShipWebsite' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_control(
            'heading_color',
            [
                'label' => esc_html__( 'Text Color', 'AnHaiShipWebsite' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Button', 'AnHaiShipWebsite' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            'button_border_width',
            [
                'label' => esc_html__( 'Border Width', 'AnHaiShipWebsite' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Border Radius', 'AnHaiShipWebsite' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
        ...
        $this->start_controls_tab( 'normal', [ 'label' => esc_html__( 'Normal', 'AnHaiShipWebsite' ) ] );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Background Color', 'AnHaiShipWebsite' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'button_border_color',
            [
                'label' => esc_html__( 'Border Color', 'AnHaiShipWebsite' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_tab( 'hover', [ 'label' => esc_html__( 'Hover', 'AnHaiShipWebsite' ) ] );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Navigation', 'AnHaiShipWebsite' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'conditions' => [
                    'relation' => 'or',
                    'terms' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Arrows', 'AnHaiShipWebsite' ),
        ...
        $this->add_control(
            'arrows_size',
            [
                'label' => esc_html__( 'Arrows Size', 'AnHaiShipWebsite' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 10,
        ...
        $this->add_control(
            'arrows_color',
            [
                'label' => esc_html__( 'Arrows Color', 'AnHaiShipWebsite' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'arrows_color_hover',
            [
                'label' => esc_html__( 'Arrows Color Hover', 'AnHaiShipWebsite' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'heading_style_dots',
            [
                'label' => esc_html__( 'Dots', 'AnHaiShipWebsite' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
                'conditions' => [
                    'terms' => [
        ...
        $this->add_control(
            'dots_size',
            [
                'label' => esc_html__( 'Dots Size', 'AnHaiShipWebsite' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 5,
        ...
        $this->add_control(
            'dots_color',
            [
                'label' => esc_html__( 'Dots Color', 'AnHaiShipWebsite' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'dots_color_hover',
            [
                'label' => esc_html__( 'Dots Color Hover', 'AnHaiShipWebsite' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
    ...
    ?>
        ...
        <div class="element-slides custom-owl-carousel owl-carousel owl-theme" data-settings-owl='<?php echo wp_json_encode( $data_settings_owl ); ?>'>
            ...
            foreach ( $settings['slides_list'] as $item ) :
                $AnHaiShipWebsite_slides_link         =   $item['link'];
                            ...
                            <div class="element-slides__item--content">
                                ...
                                <?php if ( !empty( $item['button_text'] ) ) : ?>
                                    <div class="element-slides__item--link">
                                        <?php if ( !empty( $AnHaiShipWebsite_slides_link['url'] ) ) : ?>
                                            <a href="<?php echo esc_url( $AnHaiShipWebsite_slides_link['url'] ); ?>" <?php echo ( $AnHaiShipWebsite_slides_link['is_external'] ? 'target="_blank"' : '' ); ?>>
