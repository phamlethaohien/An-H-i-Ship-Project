...
class AnHaiShipWebsite_recent_post_widget extends WP_Widget {
    ...
    public function __construct() {
        ...
        $widget_ops = array(
            'classname'     =>  'AnHaiShipWebsite_recent_post_widget',
            'description'   =>  esc_html__( 'A widget show post', 'AnHaiShipWebsite' ),
        );

        parent::__construct( 'AnHaiShipWebsite_recent_post_widget', 'Basic Theme: Recent Post', $widget_ops );
    ...
    function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'select_cat' ) ); ?>">
                <?php esc_attr_e( 'Select Categories:', 'AnHaiShipWebsite' ); ?>
            </label>
            ...
            <select id="<?php echo esc_attr( $this->get_field_id( 'select_cat' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'select_cat' ) ) . '[]'; ?>" class="widefat" size="10" multiple>
                ...
                <option value="0" <?php echo ( in_array( 0, $select_cat ) ? 'selected="selected"' : '' ); ?>>
                    <?php esc_html_e( 'All Category', 'AnHaiShipWebsite' ); ?>
                </option>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'order' ) ); ?>">
                <?php esc_html_e( 'Order:', 'AnHaiShipWebsite' ); ?>
            </label>
            ...
            <select id="<?php echo esc_attr( $this->get_field_id( 'order' ) ); ?>" name="<?php echo $this->get_field_name('order') ?>" class="widefat">
                <option value="ASC" <?php echo ( $order == 'ASC' ) ? 'selected' : ''; ?>>
                    <?php esc_html_e( 'ASC', 'AnHaiShipWebsite' ); ?>
                </option>

                <option value="DESC" <?php echo ( $order == 'DESC' ) ? 'selected' : ''; ?>>
                    <?php esc_html_e( 'DESC', 'AnHaiShipWebsite' ); ?>
                </option>
            </select>
        </p>
        ...
        <p>
            ...
            <select id="<?php echo esc_attr( $this->get_field_id( 'order_by' ) ); ?>" name="<?php echo $this->get_field_name('order_by') ?>" class="widefat">
                <option value="ID" <?php echo ( $order_by == 'ID' ) ? 'selected' : ''; ?>>
                    <?php esc_html_e( 'ID', 'AnHaiShipWebsite' ); ?>
                </option>

                <option value="date" <?php echo ( $order_by == 'date' ) ? 'selected' : ''; ?>>
                    <?php esc_html_e( 'Date', 'AnHaiShipWebsite' ); ?>
                </option>
                ...
                <option value="rand" <?php echo ( $order_by == 'rand' ) ? 'selected' : ''; ?>>
                    <?php esc_html_e( 'Rand', 'AnHaiShipWebsite' ); ?>
                </option>
            </select>
        </p>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>">
                <?php esc_html_e( 'Number of posts to show:', 'AnHaiShipWebsite' ); ?>
            </label>
...
// Register widget
function AnHaiShipWebsite_recent_post_widget_register() {
    register_widget( 'AnHaiShipWebsite_recent_post_widget' );
}

add_action( 'widgets_init', 'AnHaiShipWebsite_recent_post_widget_register' );